    ...
    <html>
        ...
        <body>
            ...
            <ol>
                ...
                <li><b>Prepare the environment</b>: Set up the necessary Python and Docker tools required for building and deploying the app.</li>
